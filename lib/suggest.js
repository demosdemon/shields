...
function twitterPage(url) {
  ...
  return {
    ...
    badge: `${baseUrl}/twitter/url/${schema}/${host}${path}.svg?style=social`,
  }
}
...
function githubIssues(user, repo) {
  ...
  return {
    ...
    badge: `${baseUrl}/github/issues/${repoSlug}.svg`,
  }
}
...
function githubForks(user, repo) {
  ...
  return {
    ...
    badge: `${baseUrl}/github/forks/${repoSlug}.svg`,
  }
}
...
function githubStars(user, repo) {
  ...
  return {
    ...
    badge: `${baseUrl}/github/stars/${repoSlug}.svg`,
  }
}
...
async function githubLicense(githubApiProvider, user, repo) {
  ...
  return {
    name: 'GitHub license',
    badge: `${baseUrl}/github/license/${repoSlug}.svg`,
    link,
  }
}
